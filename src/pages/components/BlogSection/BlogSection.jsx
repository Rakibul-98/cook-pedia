    ...
    return (
        <div className="my-20 md:flex items-center">
            ...
            <div className="md:w-6/12">
                <div className="bg-gray-200 w-9/12 mx-auto p-10 relative">
                    ...
                    <img className="absolute -bottom-2 -right-3 h-[250px] md:h-[350px] overflow-hidden" src="https://i.ibb.co/LP94N7p/blog-bg.png" alt="" />
                </div>
            </div>
        </div>
    )
